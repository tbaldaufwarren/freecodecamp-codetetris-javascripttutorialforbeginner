document.addEventListener('DOMContentLoaded',()=>{
    ...
    const theTetrominoes = [lTetromino, jTetromino, oTetromino, tTetromino, zTetromino,sTetromino,iTetromino]
    ...
    //timerId=setInterval(moveDown,1000) //(no longer needed)
    ...
    function rotate() {
      ...
      //tetrominos without rotations for display square
